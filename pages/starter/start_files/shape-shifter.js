...
var S = {
  ...
  dAudio: new Audio('./a.wav'),
  endAudio: new Audio('./end.wav'),
  ...
  init: function () {
    ...
    S.play([
      ...
      { content: '3', timeout: 2000, sound: true },
      { content: '2', timeout: 2000, sound: true },
      { content: '1', timeout: 2000, sound: true },
      { content: 'Go', timeout: 2000 },
    ])
